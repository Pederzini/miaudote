...
function getOngAnimal(idAnimal) {
  axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/ongs/${idAnimal}/contato-ong`, {
    headers: {
...
function patchMetodoContato(contato) {
  axios.patch(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/inicia-processo-adocao/${JSON.parse(sessionStorage.login_usuario).idAdotante}/${idAnimal}/${contato}`, {
    headers: {
      "Access-Control-Allow-Origin": "*",
      "crossorigin": true
    },
...
function getInfosPet() {
  mostraLoading()
  axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/animais/perfil-animal/${idAnimal}/${idAdotante}`, {
    headers: {
      "Access-Control-Allow-Origin": "*",
      "crossorigin": true
    },
...
function getAdotar() {
  axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/verifica-existencia-processo/${idAdotante}/${idAnimal}`, {
    headers: {
      "Access-Control-Allow-Origin": "*",
      "crossorigin": true
    },
...
function favoritar() {
  axios.patch(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${JSON.parse(sessionStorage.login_usuario).idAdotante}/favoritar/${idAnimal}`, {
    headers: {
      "Access-Control-Allow-Origin": "*",
      "crossorigin": true,
    },
...
function desfavoritar() {
  axios.patch(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${JSON.parse(sessionStorage.login_usuario).idAdotante}/desfavoritar/${idAnimal}`, {
    headers: {
      "Access-Control-Allow-Origin": "*",
      "crossorigin": true,
    },
