...
function getInfosFavoritos() {
    mostraLoading()
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${JSON.parse(sessionStorage.login_usuario).cnpj}/animais-favoritados`, {
        headers: {
...
function getInfosEmProcesso() {
    mostraLoading()
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${JSON.parse(sessionStorage.login_usuario).cnpj}/adocoes-em-processo`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
...
function getInfosAdotados() {
    mostraLoading()
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${JSON.parse(sessionStorage.login_usuario).cnpj}/adocoes-concluidas`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
...
function patchAdotou(idAdocao) {
    mostraLoading()
    axios.patch(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/finaliza-adocao/${idAdocao}`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
...
function patchNaoAdotou(idAdocao) {
    mostraLoading()
    axios.patch(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/cancela-adocao/${idAdocao}`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
...
function getQuemFavoritou(idAnimal) {
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${idAnimal}/pessoas-que-favoritaram`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
...
function getQuemInteressouFav(idAdotante) {
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/${idAdotante}/informacoes-pessoa-que-favoritou`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
