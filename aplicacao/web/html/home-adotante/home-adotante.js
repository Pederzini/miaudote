...
function getQtdAnimais() {
    ...
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/animais/numero-adotados`, {
        headers: {
...
function getFeedback() {
    ...
    axios.get(`ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/adocoes/feedbacks`, {
        headers: {
            "Access-Control-Allow-Origin": "*",
            "crossorigin": true
        },
