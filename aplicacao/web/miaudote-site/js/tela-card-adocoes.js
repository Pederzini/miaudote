...
function gerarRelatorio() {
    ...
    window.location.href = `https://ec2-44-198-214-72.compute-1.amazonaws.com:8443/miaudote/animais/exportacao/${cnpj}`
}
...
function getInfosCards() {
    ...
    // mostraLoading();    
    axios.get(`https://ec2-44-198-214-72.compute-1.amazonaws.com:8443/miaudote/animais/animais-ong/${JSON.parse(sessionStorage.login_usuario).cnpj}`, {
        headers: {
