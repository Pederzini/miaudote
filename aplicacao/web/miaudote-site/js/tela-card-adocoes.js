...
function gerarRelatorio() {
    ...
    window.location.href = `http://ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/animais/exportacao/${cnpj}`
}
...
function getInfosCards() {
    ...
    // mostraLoading();    
    axios.get(`http://ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/animais/animais-ong/${JSON.parse(sessionStorage.login_usuario).cnpj}`, {
        headers: {
