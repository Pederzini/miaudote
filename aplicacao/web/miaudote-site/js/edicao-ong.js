...
function getInfosOng() {
    mostraLoading()
    axios.get(`https://ec2-44-198-214-72.compute-1.amazonaws.com:8443/miaudote/ongs/${JSON.parse(sessionStorage.login_usuario).idOng}`, {
...
confirmButtonColor: '#8675A5'
        ...
        axios.patch(`https://ec2-44-198-214-72.compute-1.amazonaws.com:8443/miaudote/ongs/${JSON.parse(sessionStorage.login_usuario).idOng}`, {
            headers: { "Access-Control-Allow-Origin": "*", "crossorigin": true },
            "razaoSocial": razao,
            "cnpj": cnpj,
