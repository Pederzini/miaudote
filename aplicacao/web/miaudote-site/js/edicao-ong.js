...
function getInfosOng() {
    mostraLoading()
    axios.get(`http://ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/ongs/${JSON.parse(sessionStorage.login_usuario).idOng}`, {
...
confirmButtonColor: '#8675A5'
        ...
        axios.patch(`http://ec2-44-198-214-72.compute-1.amazonaws.com/miaudote/ongs/${JSON.parse(sessionStorage.login_usuario).idOng}`, {
            headers: { "Access-Control-Allow-Origin": "*", "crossorigin": true },
            "razaoSocial": razao,
            "cnpj": cnpj,
